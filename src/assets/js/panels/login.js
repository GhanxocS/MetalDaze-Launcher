...
async saveData(connectionData) {
    ...
    let existingAccount = allAccounts.find(acc => acc.uuid === connectionData.uuid);
    let account;
    if (existingAccount) {
        connectionData.ID = existingAccount.ID;
    ...
    configClient.account_selected = account.ID;     
        ...
        setTimeout(() => ipcRenderer.send('main-window-home-size'), 50)
        setTimeout(() => changePanel('home'), 100)
    }
}
